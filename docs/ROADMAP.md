...
| Area | DEVF | Status |
|---|---|---|
| App-from-PRD downstream stages | 070 – 071 | acceptance coverage calculator and app release packaging are not built yet |
